...
{/* Newsletter Section */}
        ...
        <section className="py-24 lg:py-32 px-6 lg:px-12 bg-[#b3123c] relative overflow-hidden"> <div className="absolute inset-0 opacity-10"> <div className="absolute top-20 left-20 w-96 h-96 bg-[#F5E1DA] rounded-full blur-3xl"></div> <div className="absolute bottom-20 right-20 w-80 h-80 bg-[#B3123D] rounded-full blur-3xl"></div> </div> <div className="relative max-w-4xl mx-auto text-center"> <h2 className="text-4xl lg:text-5xl font-serif font-light mb-6 tracking-tight text-white"> Want More Than Just a Product? </h2> <p className="text-xl lg:text-2xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed font-light"> Get intimacy insights, slow pleasure rituals and private offers — straight to your inbox. </p> {/* FORM MAILCHIMP – APENAS EMAIL, MESMO LAYOUT */} <form action="https://royalcaress.us20.list-manage.com/subscribe/post?u=464156ba230141a8d7d186f1e&id=5703186a6c&f_id=003920eef0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="max-w-md mx-auto" target="_blank" noValidate > <div className="flex flex-col sm:flex-row gap-4 bg-white/10 backdrop-blur-md rounded-full p-2"> <input type="email" name="EMAIL" id="mce-EMAIL" required placeholder="Your email address" className="bg-transparent border-0 text-white placeholder:text-white/60 text-lg px-6 py-4 focus:ring-0 flex-1 outline-none" /> <button type="submit" name="subscribe" id="mc-embedded-subscribe" className="bg-white text-[#4B1D3F] hover:bg-white/90 px-8 py-4 rounded-full font-medium transition-all duration-300 hover:scale-105" > Join the Circle </button> </div> {/* Honeypot anti-spam do Mailchimp */} <div aria-hidden="true" style={{ position: "absolute", left: "-5000px" }}> <input type="text" name="b_464156ba230141a8d7d186f1e_5703186a6c" tabIndex={-1} defaultValue="" /> </div> </form> </div> </section>
